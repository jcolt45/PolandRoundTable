  ...
  ui = tagList(
    ...
    theme = "journal",
      tabPanel("Introduction",
               h2("Project Details"),
               br(),
               p("This project is the result of a multi-year collaboration between
                  Dr. Gregory Domber, an historian, and Dr. Kelly Bodwin, a data scientist."),
               br(),
               p("We are pleased to share this application, as well as the source
                  data, free online for all investigators to use. Note, however,
                  that access to the application may be not be guaranteed based
                  on limits to the computation time we are able to provide."),
                br(),
                p("Please see the link below for instructions to access the data,
                or to run the application locally without limits."),
               br(),
               a("Project Public Access Info", href = "https://www.kelly-bodwin.com/projects/polish_networks/info-page.html"),
               br(),
               h2("Usage Instructions"),
               br(),
               p("In the SETUP tab, you will make decisions about the scope
                  of data that you wish to include in your network analysis. For
                  example, you may choose to omit certain individuals or organizations,
                  in order to highlight the patterns of others."),
               p("Make sure you click the 'Done with Setup' button to finalize
               your data choices before moving on to the next tab."),
               br(),
               p("In the EXPLORE NETWORK tab, you will choose a date to visualize
                  a snapshot of network connections. Note that the image does not
                  update until you click the 'Create Network' button.  However,
                  you can change various aesthetic elements, like the colors of the
                  nodes or the opacity of the edges, in realtime."),
               br(),
               p("In the EXPLORE TRENDS tab, you can see line plots of various
                  importance metrics for particular individuals over time. These
                  metrics are pre-computed from the full network, with no individuals
                  or organizations omitted, regardless of your choices in the SETUP tab."),
               br(),
               h2("Citation"),
               br(),
               h3("If you use this app in public research, please cite:"),
               p("Kelly Nicole Bodwin, Nguyen, Kien, & Domber, Gregory F. (2023).
                  kbodwin/PolandRoundTable: Application for visualizing social
                  networks of Polish 1989 Round Table participants. (v1.0.0).
                  Zenodo. https://doi.org/10.5281/zenodo.7837452"),
               h3("If you use this app OR the raw source data, please cite:"),
               p("Domber, Gregory F., & Bodwin, Kelly Nicole. (2023).
                  Historical institutional affiliations of participants in Poland's
                  1989 Round Table [Data set]. Zenodo.
                  https://doi.org/10.5281/zenodo.7837475")
      ),
      tabPanel("Setup",
               sidebarPanel(
                 ...
                 p("These choices are combined; for example, if you select
      ...
      tabPanel("Explore trends over time",
               sidebarPanel(
                 ...
                 h3("Choose metrics"),
                  ...
                  p("CENTRALITY (or 'betweenness') is a measure of how important
                ...
                p("DEGREE refers to the total number of connections that an
                    individual has in the network"),
                br(),

                # p("CROSS-GROUP DEGREE refers to the total number of connections
                #     that an individual has to those in different  Round Table
                #     affiliations."),
                # br(),

                p("NORMALIZED (or 'relative') measures take the chosen metric
                ...
                br(),
                 ...
                 # p("Depending on the number of individuals and the range of time
